 ...
 * @author wangzhi
 */
public final class JavadocMarkConstant {
	...
	public static final String CLASS_HEADER = "Class Documentation";

	/** Header for methods summary. **/
	public static final String METHODS_SUMMARY = "Methods Summary";

	/** Header for fields summary. **/
	public static final String FIELDS_SUMMARY = "Fields Summary";

	/** Header for constructors summary. **/
	public static final String CONSTRUCTOR_SUMMARY = "Constructors Summary";
	...
	public static final String BADGE = "[![JavadocMark](https://img.shields.io/badge/Generated%20by-JavadocMark-green.svg)](https://github.com/Faylixe/marklet)";
